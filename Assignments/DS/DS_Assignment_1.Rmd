...
> *Note*: In the following $6$ tables,
>
> -   `dist(i).1` represents the *minimum* value of the metric corresponding to $i^{th}$ distribution in the question.
>
> -   `dist(i).2` represents the *maximum* value of the metric corresponding to $i^{th}$ distribution in the question.
