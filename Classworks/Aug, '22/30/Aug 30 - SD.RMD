...
ggplot(NULL,aes(1:50))+geom_line(aes(y =samp2_mean), color = "black") +
    ...
    geom_line(aes(y = samp2_min), color = "blue") + geom_line(aes(y = 0.5), color = "purple")
```
...
```{r}
ggplot(NULL,aes(1:50))+geom_line(aes(y =samp3_mean), color = "black") +
     geom_line(aes(y =samp3_max), color = "red") +
    geom_line(aes(y = samp3_mid), color = "green") +
    geom_line(aes(y = samp3_min), color = "blue") + geom_line(aes(y = 0.5), color = "purple")
```
