...
### Draw a random sample from a BVN(0, 0, 1, 1, 0.5) of size  n, compute $b_{yx}$ and $b_{xy}$. Repeat the whole process for m Number of times. Plot the histogram and comment.
